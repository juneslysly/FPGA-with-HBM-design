...
\begin{figure}[htp]
	...
	\caption{The force of the covalent bond is calculated.These include two-force, three-force, four-force calculations, during which a portion of the IP can be reused.}
	\label{fig:bond}
\end{figure}
\section{Results}
